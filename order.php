...
$email = $_POST['email'];
$phone = $_POST['phone'];
$time_journey = $_POST['time_of_journey'];
$passenger_no = $_POST['passenger_no'];
$source = str_replace("_", " ", $_GET['source']);
$destination = str_replace("_", " ", $_GET['destination']);

include("connection.inc");
$query = "INSERT INTO `private_charter` VALUES('$fullname', '$email', '$phone', '$passenger_no', '$time_journey', '$source', '$destination')";
...
<ul class="nav navbar-nav navbar-right">
    			...
    			<div class="container padding-top-100">
                    ...
                    <h2 class="search-bus">Order logged!!</h2>
               	 	</div>
<p>Your order has been logged on our system and one of our staff will get in contact with you as soon as possible!!</p>
                    </div><!-- .col-md-12 -->
