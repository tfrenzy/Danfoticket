...
?>
<h2 class="search-bus">Cancelled Tickets</h2>
<table align="center">
<tr><td><strong>FullName</strong></td><td><strong>Email</strong></td><td><strong>Ticket Key</strong><tr>
<?php
for ($i = 0; $i < mysql_num_rows($result); $i++) {
$service = mysql_result($result, $i, "FullName");
$genkey = mysql_result($result, $i, "Email");
$source = mysql_result($result, $i, "TicketKey");
?>
<tr><td bgcolor="#D6D6D6"><?php echo $service; ?></td><td bgcolor="#00FFFF"><?php echo $genkey; ?></td><td bgcolor="#D6D6D6"><?php echo $source; ?></td></tr>
<?php
}
?>
</table>	
