...
<?php
						if (isset($_POST['Yes'])) {
						?>
	               	  <h2 class="search-bus">Please fill the form below and we will get back to you.</h2>
	    		     <form class="headerForm row-centered" method="post" action="order.php?source=<?php echo str_replace(" ", "_", $location1)?>&destination=<?php echo str_replace(" ", "_", $location2)?>">
                     <input type="text" class="form-control mid-width input-lg text-box" id="fullname" name="fullname" placeholder="Your full name">    
                     <input type="text" class="form-control mid-width input-lg text-box" id="email" name="email" placeholder="Your email">
                     <input type="text" class="form-control mid-width input-lg text-box" id="phone" name="phone" placeholder="Your phone number">    
                     <input type="text" class="form-control mid-width input-lg text-box" id="passenger_no" name="passenger_no" placeholder="Number of passengers">    
					<input type="text" class="form-control mid-width input-lg text-box" id="time_of_journey" name="time_of_journey" placeholder="Estimated time of journey (in days)">
					</div>
	    						
					<button type="submit" name="submit2" class="btn btn-primary"><span></span>Submit</button>
                    </form>
	                <?php } ?>  				
