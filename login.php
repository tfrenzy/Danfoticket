...
<form method="post" autocomplete="off" action="welcome.php">
        				<ul class="nav navbar-nav navbar-right">
                        <li><font color="#FF0000"><?php 
...
?></font></li>
<li class="active propClone"><input name="email" placeholder="Enter login email here" type="text"></li>
<li class="propClone"> and <input name="password" placeholder="Enter login password here" type="password"></li>
<li class=""><button type="submit" name="logon" class="btn btn-primary"><span></span>Login</button></li>
</ul>
</form>
</div><!-- /.navbar-collapse -->
</div><!-- /.container -->
    			...
    			<div class="container padding-top-100">
    				...
    				<div class="row row-centered">
	    		     ...
	    		     <form class="headerForm row-centered" autocomplete="off" method="post" action="register.php">
	 <h2 class="search-bus">Registration</h2>
<label for="textfield"></label>
          ...
          <table align="center">
          <tr><td bgcolor="#FFFF00">State of Origin </td><td>
          <select autocomplete="off" name="state" id="source"form-control mid-width input-lg text-box" placeholder="Enter state" tabindex="1" value="Goa" onfocus="if(this.value=='Enter a city or local area')this.value='';" onblur="if(this.value=='')this.value='Enter a city or local area';" type="text">
					...
					<option value="Zamfara">Zamfara </option>
                        ...
                        <p align="center">&nbsp;</p>
    					<button type="submit" name="signup" class="btn btn-primary"><span></span> Sign up</button>
                    </form>
               	 	   </div>
