...
<ul class="nav navbar-nav navbar-right">
    			...
    			<div class="container padding-top-100">
    				...
    				<div class="col-md-12 form-container"  style="background-image:url(images/water-bg.png)">
	               	  ...
	               	  <h2 class="search-bus">Search for bus tickets.</h2>
	    		     <form class="headerForm row-centered" method="post" action="search_registered.php">
                     <span href="javascript:" class="twowaychang"><img src="images/twoway.png" alt=""></span>
	    		     <div class="row form-fields">
				    <input type="text" class="form-control mid-width input-lg text-box" id="location-1" name="location-1" placeholder="Enter a city or town">    
					<input type="text" class="form-control mid-width input-lg text-box" id="location-2" name="location-2" placeholder="Enter a city or town">
    				<input type="text" class="form-control mid-width datepicker1" id="datepicker" placeholder="Date of Journey" name="datepicker">
                    <input type="text" class="form-control mid-width datepicker2" id="datepicker1" placeholder="Date of Return(optional)" name="datepicker1">
    	    		</div>
	    						
					<button type="submit" name="search" class="btn btn-primary"><span></span> Search</button>
	               </form>
</div><!-- .col-md-12 -->
