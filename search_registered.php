...
<h2 class="search-bus">Available bus tickets</h2>
                    <table align="center">
<tr><td><strong>Bus Service</strong></td><tr>
                     <?php
					for ($i = 0; $i < mysql_num_rows($result); $i++) {
$service = mysql_result($result, $i, "BusService");
?>
<tr><td bgcolor="#D6D6D6"><?php echo $service; ?></td><td bgcolor="#FFCCFF"><a href="purchase_registered.php?source=<?php echo str_replace(" ", "_", $location1)?>&destination=<?php echo str_replace(" ", "_", $location2)?>&destination=<?php echo str_replace(" ", "_", $location2)?>&traveldate=<?php echo $traveldate?>&returndate=<?php echo $returndate?>&serv=<?php echo $i?>">Buy from this</a></td></tr>
<?php
}
?>
</table>	
