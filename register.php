...
$stored_password = crypt($passwordd, $salt);
$state = $_POST['state'];
include("connection.inc");
$qwery = "INSERT INTO `users` VALUES('$email', '$stored_password', 'user', '$fullname', '$state', '$phone')";
...
<ul class="nav navbar-nav navbar-right">
    			...
    			<div class="container padding-top-100">
                    ...
                    <h2 class="search-bus">Registration successful!!</h2>
               	 	</div>
